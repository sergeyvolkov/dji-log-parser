...
const MOTOR_START_FAILED_CAUSE = {
  0: 'None',
  1: 'CompassError',
...
class OSD extends DJIBuffer {
  ...
  isImuInitError () {
    ...
    return reason !== 'None' && reason !== 'CollectingData' && reason !== 'MonitorError'
  }
